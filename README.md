...
- Timestamp: `2022-06-18 20:16`
- Build ID: `cb4c56a9-4b5a-48e5-9b5b-f55747be574f`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cb4c56a9-4b5a-48e5-9b5b-f55747be574f.git
$ cd cb4c56a9-4b5a-48e5-9b5b-f55747be574f
```
